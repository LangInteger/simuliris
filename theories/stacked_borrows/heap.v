...
Section val_rel.
  ...
  Proof.
    ...
    - iPoseProof (sc_rel_poison_source with "Hsc") as "?"; done.
...
Proof.
  ...
  * intros _. simpl in Hown.
    ...
    simpl in Htg. subst bor. discriminate Hlocal. done.
Qed.
...
Proof.
  ...
  iIntros "Hscrel Hcid Hbor". iDestruct "Hbor" as "(% & % & % & % & (Hc & Htag_auth & Htag_t_auth & Htag_s_auth) & #Hsrel & %Hcall_interp & %Htag_interp & %Hwf_s & %Hwf_t)".
