...
From simuliris.tree_borrows Require Import tactics class_instances.
From simuliris.tree_borrows Require Export notation defs logical_state.
...
Local Ltac log_rel_subst_l l cont :=
  ...
  | nil => cont ()
  | ?x :: ?l =>
    iApply (gen_log_rel_subst _ _ x _ _ (ValR [☠%S]) with "[]");
