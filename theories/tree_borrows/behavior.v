...
From simuliris.tree_borrows Require Import defs wf.
...
Notation expr_wf := (gen_expr_wf treeborrows_wf).
Notation ectx_wf := (gen_ectx_wf treeborrows_wf).
Notation ctx_wf := (gen_ctx_wf treeborrows_wf).
