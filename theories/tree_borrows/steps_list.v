...
(* This does not sound useful for TB
...
(* I don't think we need NoDup with the way the parent-child relationship is axiomatized
...
Proof.
  ...
  case decide => [NT|IT //]. rewrite fmap_cons.  by apply NoDup_cons_1_2.
Qed.
